...
-- DAILY_SALES_SUMMARY TABLE POLICIES
...
CREATE POLICY "Authenticated users can update daily sales summary" 
ON daily_sales_summary FOR UPDATE 
USING (true);

-- Allow authenticated users to delete daily sales summary (admin only in practice)
CREATE POLICY "Authenticated users can delete daily sales summary" 
